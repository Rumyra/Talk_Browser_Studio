...
// defaults: mass = 1, velocity = 0,0
// TODO screen dimensions need to run through everything
// TODO might rename this to mover
// ADD UPDATE FUNCTION: vel + vec, acc + vel, forces, clear acc
class Entity {
	constructor(x, y) {
